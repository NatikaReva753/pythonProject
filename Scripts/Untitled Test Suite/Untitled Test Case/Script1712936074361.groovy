...
selenium.open("http://localhost/addressbook/edit.php")
selenium.click("name=firstname")
selenium.type("name=firstname", "Nata")
selenium.click("name=middlename")
selenium.type("name=middlename", "test")
selenium.click("name=home")
selenium.type("name=home", "test")
selenium.click("name=mobile")
selenium.type("name=mobile", "test")
selenium.click("name=nickname")
selenium.type("name=nickname", "test")
selenium.click("name=lastname")
selenium.type("name=lastname", "test")
selenium.click("xpath=//div[@id='content']/form/input[20]")
selenium.click("link=home page")
selenium.open("http://localhost/addressbook/index.php")
